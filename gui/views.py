...
def get_local_settings(*prefixes):
    ...
    if 'AF-' in prefixes:
        ...
        form.append({'unit': '', 'form_id': 'af_failedhtlcboost_threshold', 'value': 5, 'label': 'HTLC Boost Threshold', 'id': 'AF-HTLCBoostThresh', 'title': 'Number of failed HTLCs within interval to trigger boost when liq below AF-LowLiqLimit. Default 5', 'min':1, 'max':100})
        form.append({'unit': 'ppm', 'form_id': 'af_failedhtlcboost_amount', 'value': 0, 'label': 'HTLC Boost Amount', 'id': 'AF-HTLCBoostAmount', 'title': 'Fixed fee increase in ppm when threshold is met. 0 disables this feature. Default 0', 'min':0, 'max':5000})
