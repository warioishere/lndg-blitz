...
def get_local_settings(*prefixes):
    ...
    if 'AF-' in prefixes:
        ...
        form.append({'unit': '', 'form_id': 'af_failedhtlcboost_threshold', 'value': 5, 'label': 'Failed HTLCs', 'id': 'AF-FailedHTLCs', 'title': 'Number of failed HTLCs within interval to trigger boost when liq below AF-LowLiqLimit. Default 5', 'min':1, 'max':100})
